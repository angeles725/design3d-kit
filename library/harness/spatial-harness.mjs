...
export class SpatialHarness {
  ...
  placeEquipment({ id, type, size, center, rotation, clearance, ports, portDN, category, system, level, parameters }) {
    ...
    this.obj.set(id, { id, type, size, center, rotation, clearance, ports, portDN, category, system, level, parameters }); // RULE 004/010 commit + BIM passthrough
