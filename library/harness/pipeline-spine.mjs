...
export function runSpine({ scene, voxelize = null, deBox = null, gateOpts = {}, strict = true } = {}) {
  ...
  // SIZE-RESOLUTION guard (from the #39 dxf-intake review): a placeholder size ([1,1,1] emitted before
  // ATTRIB SIZE / block-def bbox resolves it, tagged source.sizeSource:'placeholder') is meaningless for
  // clash/clearance/voxelize — it must NEVER silently flow into the voxel stage. Strict (default) blocks.
