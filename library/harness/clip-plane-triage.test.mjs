...
const FIX = [
  { id: 788, xext: [119.531, 123.368] },
  { id: 782, xext: [118.839, 124.101] },
  { id: 800, xext: [122.753, 126.104] }, // farthest max
  { id: 775, xext: [120.067, 125.998] },
  { id: 845, xext: [121.910, 124.536] }, // EDGE CASE: h=null (height absent-in-source)
  { id: 841, xext: [110.594, 112.878] },
  { id: 797, xext: [110.777, 114.072] },
];
