...
- **how** — how it surfaced: `blind-review-defect` · `wasted-retry` · `mechanical-failure` ·
  `user-correction` · `pre-review-catch`. A rule you cannot trace is a rule you cannot revoke.
